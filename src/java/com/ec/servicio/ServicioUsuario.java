...
public class ServicioUsuario {
    ...
    public Usuario FindUsuarioPorNombre(String nombre) {
        ...
        try {
          ...
          em.getTransaction().commit();
            ...
            System.out.println("Error en lsa consulta usuario    " +e.getMessage());
        } finally {
            em.close();
        }
    ...
    public List<Usuario> findByLikeUsuNombre(String nombre) {
    ...
    public List<Usuario> findByCorreo(String nombre) {
        ...
        try {
            ...
            em = HelperPersistencia.getEMF();
          em.getTransaction().begin();
            Query query = em.createQuery("SELECT u FROM Usuario u WHERE u.usuCorreo LIKE :usuCorreo");
            query.setParameter("usuCorreo", "%" + nombre + "%");
            listaUsuarios = (List<Usuario>) query.getResultList();
          em.getTransaction().commit();
        } catch (Exception e) {
            System.out.println("Error en lsa consulta usuarios" +e.getMessage());
